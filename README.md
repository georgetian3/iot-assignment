...
options:
  ...
  --bs BS               Run Bluetooth sender, argument is the text to be send
  ...
  --dAA DAA             The distance between mic and speaker of the sender device        
  --dBB DBB             The distance between mic and speaker of the receiver device      
  --gui                 Run GUI
  --btest sent received
...
发送方调用 `py --bs "insert Unicode string here"`
